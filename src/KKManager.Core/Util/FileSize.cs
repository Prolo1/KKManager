...
namespace KKManager.Util
{
	public readonly struct FileSize : IComparable<FileSize>, IEquatable<FileSize>, IComparable
	{
		...
		public static FileSize operator +(FileSize a, FileSize b) => new FileSize(a._sizeInKb + b._sizeInKb);

		public static FileSize operator -(FileSize a, FileSize b) => new FileSize(a._sizeInKb - b._sizeInKb);

		public static bool operator ==(FileSize a, FileSize b) => a._sizeInKb == b._sizeInKb;
		public static bool operator >(FileSize a, FileSize b) => a._sizeInKb > b._sizeInKb;
		public static bool operator <(FileSize a, FileSize b) => a._sizeInKb < b._sizeInKb;
